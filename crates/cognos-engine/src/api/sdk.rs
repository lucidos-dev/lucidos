...
/// CognOS iframe theme stylesheet — design tokens (dark/light), defaults, scrollbars.
/// Apps include via `<link rel="stylesheet" href="/api/v1/sdk-iframe.css">`.
/// Theme switching is driven by `cognos.ui.applyPreferences()` setting
/// `data-theme` on `<html>`.
...
fn find_sdk_bundle() -> String {
    let search_paths = [
        "packages/cognos-sdk/dist/sdk.js",
        "../packages/cognos-sdk/dist/sdk.js",
        "../../packages/cognos-sdk/dist/sdk.js",
    ];
    ...
    r#"(function(){
  console.warn('[CognOS SDK] Built SDK bundle not found. Run: cd packages/cognos-sdk && npm run build');
  window.cognos = window.cognos || {};
})();"#.to_string()
}
