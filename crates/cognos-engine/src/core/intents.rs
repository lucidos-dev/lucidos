...
mod tests {
    ...
    fn load_returns_none_for_missing() {
        let dir = std::env::temp_dir().join("cognos_test_intents_missing");
    ...
    fn load_finds_standalone_trigger() {
        let dir = std::env::temp_dir().join("cognos_test_standalone_trigger_intent");
        let _ = std::fs::remove_dir_all(&dir);
    ...
    fn load_finds_app_intent() {
        let dir = std::env::temp_dir().join("cognos_test_app_intent");
        let _ = std::fs::remove_dir_all(&dir);
    ...
    fn load_finds_app_trigger() {
        let dir = std::env::temp_dir().join("cognos_test_app_trigger_intent");
        let _ = std::fs::remove_dir_all(&dir);
    ...
    fn load_all_discovers_from_all_locations() {
        let dir = std::env::temp_dir().join("cognos_test_load_all_intents");
        let _ = std::fs::remove_dir_all(&dir);
