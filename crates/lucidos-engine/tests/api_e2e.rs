...
//!
//! These tests hit a running Lucidos workspace and are marked `#[ignore]` so a
//! bare `cargo test -p lucidos-engine` passes without infra. Run via:
//!   ./scripts/e2e-api.sh
