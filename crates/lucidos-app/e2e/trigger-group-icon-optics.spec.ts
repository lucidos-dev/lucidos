 ...
 *  at that class's nominal size (`--icon-glyph`, `--icon-size-md` for a row
 *  icon, one step under the header band's). What differs is how much of that
 *  glyph each icon actually paints: the pencil's ink is 20.12 of its 24 viewBox
 *  units and the trash's is 16.00, so the trash rendered a fifth shorter inside
 *  an identical box.
 *
