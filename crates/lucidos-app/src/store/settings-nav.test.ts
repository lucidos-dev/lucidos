...
describe('settings navigation', () => {
  it('keeps System last in the main settings list and owns Thread Queue, Backup, Memory, Disk Usage, and Environment Variables as subpanels', () => {
    ...
    expect(SETTINGS_SYSTEM_SUBPANEL_ITEMS.map((item) => item.key)).toEqual(['thread-queue', 'backup', 'memory', 'disk-usage', 'environment-variables']);
