 ...
 *
 *   cognos-draft:<id>          → raw textarea contents (string)
 *   cognos-draft-images:<id>   → JSON-encoded PastedImage[] (string)
 *   cognos-draft-updated:<id>  → ISO timestamp of the last edit (string)
 *
 * The image payload is owned by `components/chat/pastedImages.ts`; this
 * module only stores/loads the raw JSON it produces.
 */

export const DRAFT_TEXT_PREFIX = 'cognos-draft:';
export const DRAFT_IMAGES_PREFIX = 'cognos-draft-images:';
export const DRAFT_UPDATED_PREFIX = 'cognos-draft-updated:';
...
export const FOCUSED_THREAD_KEY = 'cognos-focused-thread';
export const FOCUSED_DRAFT_KEY = 'cognos-focused-draft';
