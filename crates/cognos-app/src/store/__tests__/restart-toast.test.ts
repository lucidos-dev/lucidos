...
const RESTART_GROUPS_LS_KEY = 'cognos-restart-groups';
const LEGACY_REASONS_LS_KEY = 'cognos-restart-reasons';
...
describe('restart groups tracking (thread title + commits)', () => {
  ...
  it('restoreRestartToast ignores legacy "cognos-restart-reasons" key', () => {
    localStorage.setItem(RESTART_LS_KEY, 'true');
