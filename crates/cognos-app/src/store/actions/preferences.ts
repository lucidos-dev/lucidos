...
export function applyTheme(theme: Theme): void {
  ...
  localStorage.setItem('cognos-theme', theme);
...
export function currentTheme(): Theme {
  ...
  return currentPreference('theme', ['light', 'dark', 'system'], 'dark', undefined, 'cognos-theme');
}
...
export function currentNotificationsFilter(): 'all' | 'unread' {
  return currentPreference('notifications_filter', ['all', 'unread'], 'all', undefined, 'cognos-notifications-filter');
}
