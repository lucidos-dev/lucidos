...
export type SessionEndReason = 'completed' | 'user_ended' | 'changes_proposed' | 'changes_applied' | 'auto_ended' | 'shutdown' | 'panic' | 'stale_resume' | 'discarded';
export const SESSION_END_REASONS: readonly SessionEndReason[] = ['completed', 'user_ended', 'changes_proposed', 'changes_applied', 'auto_ended', 'shutdown', 'panic', 'stale_resume', 'discarded'] as const;
