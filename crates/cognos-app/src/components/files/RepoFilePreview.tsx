...
import { selectedLines, repoDiff, repoPending, filePreviewSource, popupImageSrc } from '../../store/store';
...
export function RepoFilePreview({ repoId, mode, path }: Props) {
  if (mode === 'diff') {
    ...
    if (file) return <DiffView file={file} />;
    return <div class="empty-state">File not found in diff</div>;
  }
