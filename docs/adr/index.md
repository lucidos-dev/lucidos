...
- [0087: The graduation eval for the experimental context mode is a paired two-workspace sequence scored on planted probes, not on whether the task got done](0087-context-mode-eval-graduation-bar.md)
